...
const EduForm = (props) => {
  ...
  //   const tempArray = [...educationOptions];
  //   const ans = tempArray.forEach((item, index) => {
  //     if (arr.includes(item.value)) {
  //       item.check = false;
  //       console.log(index);
  //       setEducationOptions(tempArray, educationOptions.slice(index, 1));
            ...
            <Form>
              ...
              <FieldArray name="educations">
                ...
                //   ); 
                  ...
                  const finalArr = filterTwoArrays(Object.values(educationOptions).map(({value})=>value), Object.values(values.educations).map(({name})=>name))
